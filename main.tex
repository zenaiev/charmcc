...
%
The $\pm$ superscript on $\sigma$ and $F$ correspond to the sign of $W^\pm$. 
%
...
%
In the presence of strong contraints (the LHeC data is very precise),
...
SM process can indirectly impact beyond-standard-model (BSM) signatures.
...
%\bibliographystyle{spphys} \bibliography{c_cpaper,extra}
