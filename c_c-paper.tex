...
instructive.
%
We see that at low $Q^2$ scales the FFNS (\ffns and \ffnsb) and VFNS
...
The VFNS includes a resummation of the higher order logs of the form $\alpha_s \ln(\mu^2/m_c^2 )$.
...
additional contribution of the resummed logs.
...
that the PDF constraints can be obtained in a rather model independent way.}
...
collisions probe $\bar{s}$, only mild constraints are put on $s/\overline{s}$ 
