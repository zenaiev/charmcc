...
We study the the charged current DIS  production of charm using the
...
PDF uncertainty, and use LHeC pseudodata to compute the potential
...
could substantially improve the $s(x)$ PDF uncertainties. 
