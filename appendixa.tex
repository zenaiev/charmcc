...
becomes collinear and close to the mass-shell.\footnote{For example, the charm quark is off-shell by the order of its mass
...
$c\bar{c}$ loop contributions.
Note; this deficiency can in principle be patched order-by-order by
...
top quark.\footnote{Additionally, Collins definitively addressed the case of multiple
