...
\begin{figure*}[t]
\centering
\includegraphics[width=0.9\textwidth]{./pics/fred/pasted1}
\caption{\textcolor{blue}{
We may modify or trim this or switch to charm.} The
LO contributions correspond to the heavy quark initiated $f_{b}$,
and the SUB to $\tilde{f}_{b}$. The cancellation (LO-SUB) is quite
